  ...
  <footer className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-1 flex flex-col justify-start mr-10">
        <img src={logo} alt="hoo ban logo" className="w-[266px] h-[72px] object-contain"/>
    ...
    <div className="w-full flex justify-between items-center flex-col md:flex-row pt-8 border-t-[1px] border-t-[#3f3e45]">
      <p className="font-poppins font-normal text-center text-[18px] text-white">Copyright Ⓒ 2022 HooBank. All Rights Reserved.</p>
